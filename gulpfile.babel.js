...
gulp.task('build',
 gulp.series(clean, gulp.parallel(pages, sass, javascript, images, copy, copyPhp, fonts)));
...
// Copy php files from src to dist folder
function copyPhp() {
  return gulp.src('src/**/*.php')
      .pipe(gulp.dest(PATHS.dist));
}

// Copy font files from src to dist folder
function fonts() {
